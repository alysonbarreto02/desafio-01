export default function Tasks() {
    return (      
        <div className="w-8/12 mt-9 mx-6 h-96 bg-gray-100 flex-col rounded-lg">
            <div className="w-full h-14 bg-white mx-auto flex rounded-md">
                <div className="flex ml-7 w-full cdx-auto">
                    <p className="w-full my-auto font-bold text-xl text-gray-900">Tasks</p>
                </div>
            </div>
